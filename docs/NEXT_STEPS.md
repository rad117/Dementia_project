...
- The legacy mock endpoint (`POST /api/assessments`, `mock-0.0`) was removed 2026-09-20 in a backend cleanup pass. The demo auth stubs remain temporary scaffolding, not a production path — don't let it get mistaken for the real thing in a demo or a report.
